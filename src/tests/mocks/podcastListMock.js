export const podcastList = [
    ...
    data:
  {
    feed: {
      ...
      entry: [
        {
          ...
          'im:releaseDate': {
            label: '2023-03-01T00:00:00-07:00',
            attributes: {
              label: 'March 1, 2023'
            }
          }
      ...
      updated: {
        label: '2023-03-05T04:08:42-07:00'
      },
      rights: {
      ...
      link: [
        ...
        },
        {
          attributes: {
            rel: 'self',
            href: 'https://mzstoreservices-int.dslb.apple.com/us/rss/toppodcasts/limit=2/genre=1310/json'
          }
        }
      ],
      id: {
